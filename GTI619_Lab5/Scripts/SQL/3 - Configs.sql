INSERT INTO [dbo].[AuthentificationConfig] ([Id], [IsPeriodic], [IsUpperCase], [IsLowerCase], [IsSpecialCase], [IsNumber], [PeriodPeriodic], [MaxLenght], [MinLenght], [TimeOutSession], [NbrLastPasswords], [StrongAuthentication]) VALUES (N'dd301ae6-0e1f-4e52-a7c2-bbee44019931', 0, 1, 1, 0, 1, 30, 25, 8, 20, 3, true);
